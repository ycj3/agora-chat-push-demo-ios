...
public class MessageInputView: UIView {
    ...
    private lazy var sendFileMessageButton: UIButton = {
        ...
        sendFileMessageButton.setImage(UIImage(named: "imgBtnSendFileMsgNormal"), for: .normal)
        sendFileMessageButton.setImage(UIImage(named: "imgBtnSendFileMsgPressed"), for: .highlighted)
    ...
    private lazy var sendUserMessageButton: UIButton = {
        ...
        sendUserMessageButton.setImage(UIImage(named: "imgBtnSendUserMsgPressed"), for: .normal)
